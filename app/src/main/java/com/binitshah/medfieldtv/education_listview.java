...
public class education_listview extends Fragment {
    ...
    private static final String url = "http://binitshah.com/education_list.json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_education_listview, container, false);

        listView = (ListView) v.findViewById(R.id.elist);
        adapter = new CustomListAdapter(getActivity(), showList);
        listView.setAdapter(adapter);

        textView = (TextView) v.findViewById(R.id.channelnumber1);
        setChannelNum();
    ...
    public void setChannelNum(){
        ...
        if(provider.equals("Comcast")){
            textView.setText("Channel 12");
        }
        else if(provider.equals("Verizon")){
            textView.setText("Channel 36");
        }
        else{
